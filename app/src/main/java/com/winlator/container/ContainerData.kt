...
data class ContainerData(
    ...
    val sfCompatMode: Boolean = false,
    val lowGraphicsMode: Boolean = false,
        ...
        val Saver = mapSaver(
            save = { state ->
                mapOf(
                    ...
                    "lowGraphicsMode" to state.lowGraphicsMode,
            ...
            restore = { savedMap ->
                ContainerData(
                    ...
                    sfCompatMode = (savedMap["sfCompatMode"] as? Boolean) ?: false,
                    lowGraphicsMode = (savedMap["lowGraphicsMode"] as? Boolean) ?: false,
